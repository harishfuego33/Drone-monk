...
const Process = () => {
  return (
    <>
      <h1 className="how__its-works">How its works</h1>
        ...
        <div className="service__process-top">
          <div className="service__item-top">
            <p className="service__para service__para-odd">
              Reach out to us via our website or phone to book your drone
              service. Share the details. and we&apos;ll shoot you a
              confirmation email.
            </p>
          </div>
          <div className="service__item-top">
          ...
          <div className="service__item-top">
            <p className="service__para service__para-odd">
              Pack your drone snugly and courier it to our address. We'll ping
              you as soon as it lands safely with us.
            </p>
          </div>
          <div className="service__item-top">
            <div className="service__step">
        ...
        <div className="service__process-btm">
          ...
          <div className="service__item-btm">
            <p className="service__para service__para-even">
              ...
              services it, runs thorough tests, and emails you a quote. Your
              drone will be ready for action in no time!
            </p>
          </div>
          <div className="service__item-btm">
            <div className="service__step-even">
          ...
          <div className="service__item-btm">
            <p className="service__para service__para-even">
              ...
              back to your address. Enjoy your perfectly serviced drone, ready
